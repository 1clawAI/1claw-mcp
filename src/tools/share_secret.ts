    ...
    return {
        ...
        parameters: z.object({
            ...
            recipient_id: z
                ...
                .optional()
                .describe(
                    "UUID of the recipient user or agent (required for user/agent types, not needed for creator)",
                ),
            expires_at: z
                .string()
            ...
            max_access_count: z
                ...
                .default(5)
                .describe(
                    "Max number of times the secret can be accessed (default: 5)",
                ),
        }),
        execute: async (args: {
            secret_id: string;
            ...
            if (
                (args.recipient_type === "user" ||
                    args.recipient_type === "agent") &&
                !args.recipient_id
            ) {
